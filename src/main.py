...
#         print("Compiler object initialized")
...
#     # Check if grammar file exists before loading parse tables
#     if not os.path.exists(self.grammar):
#         raise CompilerMessage(f"Grammar file '{self.grammar}' not found.")
...
class Compiler:
    ...
    def __init__(self, options):
        ...
        if self.grammar is None:
            ...
            self.grammar = "/Users/pujakadayat/PYTHON/compiler/grammars/main_grammar.txt"
            # "grammars/main_grammar.txt"
